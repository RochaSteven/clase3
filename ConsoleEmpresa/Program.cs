...
namespace ConsoleEmpresa
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var empleadoNuevo = new Empleado { Nombre = "light Yagamy" };
            var emNuevo = empresa2.contratarEmpleado(empleadoNuevo);

            var resultadoConstruccion = empresa2.Construir();
            ...
            Console.WriteLine("el nuevo cliente" + cliente1.Nombre + "con el apellido: " + cliente1.Apellido);
            Console.WriteLine("El consumo por un mes en galones es de:" + carro.Consumo(1, 30, 2));
            Console.WriteLine(resultadoConstruccion);
            Console.WriteLine(emNuevo);
            Console.ReadKey();
        }
    }
}
